...
class CIFAR10Data(object):
    ...
    def get_stretch_data(self, subtract_mean=True):
        ...
        y_train = tensorflow.keras.utils.np_utils.to_categorical(self.y_train, num_classes)
        ...
        y_test = tensorflow.keras.utils.np_utils.to_categorical(self.y_test, num_classes)
